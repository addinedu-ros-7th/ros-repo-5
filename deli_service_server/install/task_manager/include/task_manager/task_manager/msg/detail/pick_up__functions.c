...
task_manager__msg__PickUP__init(task_manager__msg__PickUP * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->item)) {
    task_manager__msg__PickUP__fini(msg);
    return false;
  }
  // quantity
  return true;
...
task_manager__msg__PickUP__create(void)
{
  ...
  task_manager__msg__PickUP * msg = (task_manager__msg__PickUP *)allocator.allocate(sizeof(task_manager__msg__PickUP), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(task_manager__msg__PickUP));
  bool success = task_manager__msg__PickUP__init(msg);
  if (!success) {
...
task_manager__msg__PickUP__Sequence__init(task_manager__msg__PickUP__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  task_manager__msg__PickUP * data = NULL;

  if (size) {
    data = (task_manager__msg__PickUP *)allocator.zero_allocate(size, sizeof(task_manager__msg__PickUP), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = task_manager__msg__PickUP__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        task_manager__msg__PickUP__fini(&data[i - 1]);
      }
...
task_manager__msg__PickUP__Sequence__fini(task_manager__msg__PickUP__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      task_manager__msg__PickUP__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  task_manager__msg__PickUP__Sequence * array = (task_manager__msg__PickUP__Sequence *)allocator.allocate(sizeof(task_manager__msg__PickUP__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = task_manager__msg__PickUP__Sequence__init(array, size);
  if (!success) {
...
task_manager__msg__PickUP__Sequence__destroy(task_manager__msg__PickUP__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    task_manager__msg__PickUP__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
task_manager__msg__PickUP__Sequence__are_equal(const task_manager__msg__PickUP__Sequence * lhs, const task_manager__msg__PickUP__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!task_manager__msg__PickUP__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  task_manager__msg__PickUP__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(task_manager__msg__PickUP);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    task_manager__msg__PickUP * data =
      (task_manager__msg__PickUP *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!task_manager__msg__PickUP__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          task_manager__msg__PickUP__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!task_manager__msg__PickUP__copy(
