...
class MainPage(QMainWindow, MainUIClass):
    def __init__(self, user_id=None):
        ...
        pixmap = QPixmap("/home/truman/github/deli_deli/src/deli_ws/deli_ui/User_UI/img/2.png")
        print("Pixmap2 is null?", pixmap.isNull())
        self.image_2.setPixmap(pixmap)
        self.image_2.setScaledContents(True)

        pixmap = QPixmap("/home/truman/github/deli_deli/src/deli_ws/deli_ui/User_UI/img/3.jpg")
        print("Pixmap1 is null?", pixmap.isNull())
        ...
        pixmap = QPixmap("/home/truman/github/deli_deli/src/deli_ws/deli_ui/User_UI/img/5.png")
        print("Pixmap1 is null?", pixmap.isNull())
